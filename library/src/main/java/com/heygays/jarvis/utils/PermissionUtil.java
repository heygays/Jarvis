...
/**
 * @author：HeyGays
 * @description： (收集的) * 很多手机对原生系统做了修改，比如小米4的6.0的shouldShowRequestPermissionRationale
...
public class PermissionUtil {
    ...
    public void requestPermissions(@NonNull CharSequence hintMessage,
        ...
        if (!hasPermissions(mContext, permissions)) {
            ...
            mListener.doAfterGranted(permissions);
        }
    }
        ...
        switch (requestCode) {
            case REQUEST_PERMISSION_CODE:
                ...
                if (allGranted && mListener != null) {
                    ...
                    mListener.doAfterGranted((String[]) mPermissionList.toArray());
    ...
    public interface PermissionListener {
        ...
        void doAfterGranted(String... permission);
