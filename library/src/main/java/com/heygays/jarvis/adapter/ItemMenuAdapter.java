package com.heygays.jarvis.adapter;

import com.heygays.jarvis.widgets.ItemMenuView;
...
public abstract class ItemMenuAdapter extends BaseAdapter {
	...
	public final View getView(int position, View convertView, ViewGroup parent) {
		ItemMenuView view = getItemView(position, (ItemMenuView) convertView,
				parent);
	...
	public abstract ItemMenuView getItemView(int position,
			ItemMenuView convertView, ViewGroup parent);
}
